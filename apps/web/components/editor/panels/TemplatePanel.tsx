...
export function TemplatePanel({ canvas }: TemplatePanelProps) {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      {/* 검색창 */}
      <div className="relative px-5 py-4 border-b border-[var(--editor-border)] shrink-0">
        <Search
          className="absolute left-5 top-1/2 -translate-y-1/2 size-4 text-[var(--editor-text-muted)] pointer-events-none"
          aria-hidden="true"
        />
        <input
          ref={searchRef}
      ...
      <div className="flex-1 overflow-y-auto p-5">
        {loading ? (
          ...
          // 그리드
          <div className="grid grid-cols-2 gap-5" role="list" aria-label="템플릿 목록">
      ...
      <div
        className={cn(
          'shrink-0 px-5 py-4 border-t border-[var(--editor-border)]',
