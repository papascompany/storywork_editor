...
export function WordFxPanel({ canvas, history }: WordFxPanelProps) {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      {/* 검색창 */}
      <div className="px-6 py-4 border-b border-[var(--editor-border)] shrink-0">
        <input
          ref={searchRef}
          type="search"
          aria-label="워드효과 검색"
      ...
      {!query.trim() && (
        <div
          className="flex overflow-x-auto gap-1 px-6 py-4 border-b border-[var(--editor-border)] shrink-0 scrollbar-none"
          role="tablist"
          aria-label="효과 카테고리"
        >
          <button
      ...
      {/* 개수 표시 */}
      <div className="px-6 py-4 border-t border-[var(--editor-border)] shrink-0">
