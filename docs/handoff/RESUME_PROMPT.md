...
- **대사/지문 구분**(SCRIPT-KO-04) — 헤딩은 장면 메타로 흡수, 서술·지문은 캡션 박스로.
  페이지 255 → 218 → (프리셋 수정 후) 222
- 포즈 자산 수치 정본 확정(ADR-0019): raw 1,260 · 태깅 대상 1,243 · 사이드카 1,058 · prod 1,262
- 한글 PDF 실가동 — prod 배포 완료, 실 publish 육안 확인만 남음

### 🔴 대표님 액션 4건 — **전부 미실행**. 세션 시작 시 진행 여부부터 물을 것

08-07 에 4건 모두 진행 의사를 밝히셨습니다. 실행 결과만 공유해 주시면 후속은 어시가 이어받습니다.
...
> 부재 — 1·3번 미실행 확정. 2·4번은 prod 접근이 필요해 직전 세션의 실측 기록을 인용한 것.
...
**키 등록 전이면 LAYOUT-05 부터** 진행하면 됩니다.
