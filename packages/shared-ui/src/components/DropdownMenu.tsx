 ...
 * DropdownMenu 컴포넌트
 *
 * @radix-ui/react-dropdown-menu 베이스.
 * - 다크모드 자동 (CSS 변수)
 * - 접근성: 키보드 탐색, 포커스 트랩
 * - 터치 타겟 ≥ 44px 를 item 내부에서 확보
 *
 * @example
 * <DropdownMenu>
 ...
 *   </DropdownMenuTrigger>
 *   <DropdownMenuContent>
 *     <DropdownMenuItem onSelect={() => console.log('클릭')}>항목</DropdownMenuItem>
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-[30] min-w-[8rem] overflow-hidden',
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'rounded-[var(--radius-sm)]',
      'px-2 py-2 text-sm',
      'min-h-[2.75rem]', // ≥ 44px 터치 타겟
      'text-[var(--color-text)]',
      'outline-none transition-colors',
      'focus:bg-[var(--color-surface-muted)] focus:text-[var(--color-text)]',
